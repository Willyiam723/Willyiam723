...
- 🌱 Experienced in building analytics applications by turning business problems into data science questions, and resolving it using analytics
...
- 💻 Programming Languages: Python | R | C | SQL | Javascript | HTML | CSS | Lua 
- 🔬 Data Science: Python (NumPy, Pandas, Pyspark, Matplotlib, Plotly, Scikit-learn, SciPy, NLTK)
- 🌐 Web Development: Python (Django, Flask) | Javascript | HTML | CSS
- 🔍 Web Scrapping: Python (BeautifulSoup, Selenium)
- 🎮 Game Development: Lua, Love2D, Unity3D
...
<!--START_SECTION: top projects-->
- 🔮 **[FPL Prediction](https://github.com/Willyiam723/fpl)**
